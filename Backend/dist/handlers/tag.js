...
var index = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                error_1 = _a.sent();
                res.status(400).send("Unable to show the tags : " + error_1);
                return [3 /*break*/, 3];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                id = _req.params.id;
                if (!id)
                    throw new Error("bad parameters or no parameters Provided");
                return [4 /*yield*/, store.show(Number(id))];
            case 1:
                result = _a.sent();
                if (!result)
...
var create = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, title, path, result, error_3;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                _a = _req.body, title = _a.title, path = _a.path;
                if (!title || !path)
                    throw new Error("Missing paramaters");
                return [4 /*yield*/, store.create(title, path)];
            case 1:
                result = _b.sent();
                res.send(result);
                return [3 /*break*/, 3];
            case 2:
                error_3 = _b.sent();
                res.status(400).send("Unable to create the tag : " + error_3);
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
    });
...
var tagRoute = function (app) {
    ...
    app.get('/tag/:id', show);
    app.post('/tag', express_1.default.json(), create);
};
