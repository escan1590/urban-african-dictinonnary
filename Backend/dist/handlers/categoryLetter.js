...
var index = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                error_1 = _a.sent();
                res.status(400).send("Unable to show category_letter items : " + error_1);
                return [3 /*break*/, 3];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                result = _a.sent();
                if (!result)
                    throw new Error("No category_letter found");
                res.send(result);
                return [3 /*break*/, 3];
            case 2:
                error_2 = _a.sent();
...
var categoryLetterRoute = function (app) {
    app.get('/category_letter/all', index);
    app.get('/category_letter/:id', show);
};
exports.default = categoryLetterRoute;
